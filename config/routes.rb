SpinuplabsWeb::Application.routes.draw do
  ...
  match "/blog/2013/03/12/startup-metrics-with-keen", :to => redirect("/posts/startup-metrics-with-keen-io")
  ...
  match "/blog/2012/12/05/killing-features-vanity-metric", :to => redirect("/posts/killing-features-is-a-vanity-metric")
